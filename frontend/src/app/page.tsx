...
export default function HomePage() {
  ...
  return (
    <div className="w-full relative flex flex-col mt-[-72px]">
      ...
      {/* ════════════ DARK HERO SECTION ════════════ */}
      <section className="relative w-full min-h-screen flex flex-col items-center px-6 pb-12 pt-28 md:px-12 md:pb-12 md:pt-32 z-0">
        ...
        <div className="flex flex-1 w-full flex-col items-center justify-center pt-8 md:pt-12">
          {/* Center Massive Headline */}
          <h1 className="font-sans font-black text-6xl md:text-8xl lg:text-[8rem] xl:text-[9rem] uppercase leading-[0.8] tracking-tighter text-[#F4F4F4] text-center mix-blend-difference pointer-events-none select-none">
